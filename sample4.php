            ...
            while ($posts_query->have_posts()) {
                ...
                if ($selected_service == $service_name) { ?>
                    <div class="sd-posts-item">
                        ...
                        <div class="sd-posts-col">
                            <div class="sd-post-name">SERVICE:
                                <?= $service_name ?>
                            </div>
                            <div class="sd-podt-content">
                                <?= $service_content ?>
                            </div>
                ...
                while ($posts_query->have_posts()) {
                    ...
                    <div class="sd-blog-item">
                        <div class="sd-blog-col">
                            <div class="sd-blog-image"><a href="<?= $post_link ?>"><img src="<?= $post_image ?>"
                                        alt="<?= $post_name ?>"></a></div>
                        </div>
                        <div class="sd-blog-col">
                            <div class="sd-blog-date">
                                <?= $post_date ?>
                            </div>
                        </div>
                        <div class="sd-blog-col">
                            <div class="sd-blog-name">
                                <?= $post_name ?>
                            </div>
                        </div>
                        <div class="sd-blog-col">
                            <!-- 								<div class="sd-blog-author"><img src="< $selected_member_image ?>" alt="< $member_name ?>"> Author: < $selected_member ?></div> -->
                            <div class="sd-blog-author"><img src="/wp-content/plugins/sd-custom-codes/assets/img/auth-icon.jpg"
                                    alt="<?= $member_name ?>"> Author:
                                <?= $selected_member ?>
                            </div>
                        </div>
                        <div class="sd-blog-col">
                        ...
                        <div class="sd-blog-col">
                            <div class="sd-blog-link"><a href="<?= $post_link ?>">Read More <i class="fa fa-long-arrow-right fa-2x"
                                        style="position: relative; top: 4px; left: 15px;" aria-hidden="true"></i></a></div>
                        </div>
                    </div>
                    <?php
                }
                ...
                while ($posts_query->have_posts()) {
                    ...
                    <div class="sd-service-item">
                        ...
                        <div class="sd-service-col">
                            <div class="sd-service-name">
                                <?= $contact_name ?>
                            </div>
                            <div class="sd-service-position">
                                <?= $contact_position ?>
                            </div>
                            <div class="sd-service-discussion">
                                <?= $contact_discussion ?>
                            </div>
                            <div class="sd-service-link"><a href="<?= $contact_link ?>">Learn More <i
                                        class="fa fa-long-arrow-right fa-2x By_learnmore_pointer" aria-hidden="true"></i></a></div>
                        </div>
                    </div>
                    <?php
                ...
                while ($posts_query->have_posts()) {
                    ...
                    <div class="sd-industry-item">
                        ...
                        <div class="sd-industry-col">
                            <div class="sd-industry-name">
                                <?= $contact_name ?>
                            </div>
                            <div class="sd-industry-position">
                                <?= $contact_position ?>
                            </div>
                            <div class="sd-industry-discussion">
                                <?= $contact_discussion ?>
                            </div>
                            <div class="sd-industry-link"><a href="<?= $contact_link ?>">Learn More <i
                                        class="fa fa-long-arrow-right fa-2x By_learnmore_pointer" aria-hidden="true"></i></a></div>
                        </div>
                    </div>
                    <?php
